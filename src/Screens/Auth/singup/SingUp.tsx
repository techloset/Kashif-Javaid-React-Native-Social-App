...
const {username,setUserName,badusername,email,setEmail,bademail,password,setPassword,badpassword,
  confirmpass,setConfirmpass,badconfirmpass,handleSignUp,onGoogleButtonPress
}=useSingup(props);
